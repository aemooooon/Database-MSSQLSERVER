...
-- © Itzik Ben-Gan 
---------------------------------------------------------------------
-- Create Database as per file TSQL2012Sample-TransactionsDB.sql in the Databases folder.
-- In all exercises in this chapter, make sure you have created and are connected
-- to the YourUserName_TSQL2012 sample database
-- by running the following code:

USE krissiw_TSQL2012;
...
ALTER DATABASE krissiw_TSQL2012 SET ALLOW_SNAPSHOT_ISOLATION ON;
...
-- 2-6a
-- Turn on READ_COMMITTED_SNAPSHOT in the krissiw_TSQL2012 database: (in SQL Azure ON by default)
ALTER DATABASE krissiw_TSQL2012 SET READ_COMMITTED_SNAPSHOT ON;
...
ALTER DATABASE krissiw_TSQL2012 SET ALLOW_SNAPSHOT_ISOLATION OFF;
ALTER DATABASE krissiw_TSQL2012 SET READ_COMMITTED_SNAPSHOT OFF;
