...
INSERT INTO Paper
    (PaperID,PaperName)
VALUES
    ('IN338', 'Level 3 English'),
    ('IN238', 'Level 2 English');
...
INSERT INTO Person
    (PersonID,GivenName,FamilyName,FullName)
VALUES
    ('188', 'Hua', 'WANG', 'Hua WANG');
INSERT INTO Enrolment
    (PaperID,SemesterID,PersonID)
VALUES
    ('IN705', '2019S2', (SELECT PersonID
        FROM Person
        WHERE FullName='Hua WANG'));
INSERT INTO Enrolment
    (PaperID,SemesterID,PersonID)
VALUES
    ('IN628', '2019S1', (SELECT PersonID
        FROM Person
        WHERE FullName='Hua WANG'));
INSERT INTO Enrolment
    (PaperID,SemesterID,PersonID)
VALUES
    ('IN612', '2019S1', (SELECT PersonID
        FROM Person
        WHERE FullName='Hua WANG'));
...
VALUES
    ('2021S1', '2021-02-24', '2021-06-27');
INSERT INTO PaperInstance
    (PaperID,SemesterID)
SELECT p.PaperID, '2021S1'
FROM Paper p JOIN PaperInstance [pi] ON p.PaperID=[pi].PaperID
GROUP BY p.PaperID;
